...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-DYlhdcjt.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-81eQxVv-.js', import.meta.url).href),import:true},'lit':{get:()=>()=>__federation_import(new URL('__federation_shared_lit-7fI1iU3V.js', import.meta.url).href),import:true},'zustand':{get:()=>()=>__federation_import(new URL('__federation_shared_zustand-CKAI7VcA.js', import.meta.url).href),import:true}};
